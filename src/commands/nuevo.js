...
async function handleBandaButton(interaction, client) {
  ...
  if (banda === "COMUNIDAD") {
    ...
    rolesAsignar = ["1516258985286696961", "1516258980601659583", "1516258974163402862", "1527465920803504318"];
  } else if (banda === "RUSH") {
    rolesAsignar = ["1518491812593926274", "1516258974163402862", "1516258980601659583", "1516258985286696961"];
  } else if (banda === "BLUEBERRY") {
    rolesAsignar = ["1516258985286696961", "1516258980601659583", "1516258974163402862", "1525397550046122034"];
  }
